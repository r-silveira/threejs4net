...
namespace ThreeJs4Net.Renderers
{
    ...
    public class WebGLRenderer : IDisposable
    {
        ...
        public WebGLRenderer(Control control)
        {
            ...
            this.ClearColor = Color.ColorName(ColorKeywords.black);
            this.ClearAlpha = 0;
...
//                new ShadowMapPlugin(this, this._lights, this._webglObjects, this._webglObjectsImmediate);
...
//            else
//            {
//                GL.RenderbufferStorage(RenderbufferTarget.Renderbuffer, RenderbufferStorage.Rgba4, renderTarget.Width,
//                    renderTarget.Height);
//            }
//        }
...
//                    GL.TexImage2D(TextureTarget.Texture2D, 0, glInternalFormat, renderTarget.Width, renderTarget.Height,
...
//                this.RenderObjects(this.opaqueObjects, camera, this.Lights, fog, true, material);
//                this.RenderObjects(this.transparentObjects, camera, this.Lights, fog, true, material);
//                this.RenderObjectsImmediate(this._webglObjectsImmediate, string.Empty, camera, this.Lights, fog, false,
//                    material);
//            }
//            else
//            {
...
//                this.RenderObjects(this.opaqueObjects, camera, this.Lights, fog, false, material);
//                this.RenderObjectsImmediate(this._webglObjectsImmediate, "opaque", camera, this.Lights, fog, false,
//                    material);

//                // transparent pass (back-to-front Order)

//                this.RenderObjects(this.transparentObjects, camera, this.Lights, fog, true, material);
//                this.RenderObjectsImmediate(this._webglObjectsImmediate, "transparent", camera, this.Lights, fog, true,
//                    material);
//            }
...
//            if (this.extensions.Contains("WEBGL_compressed_texture_s3tc")
//                || this.extensions.Contains("MOZ_WEBGL_compressed_texture_s3tc")
//                || this.extensions.Contains("WEBKIT_WEBGL_compressed_texture_s3tc") ||
//                this.extensions.Contains("GL_S3_s3tc"))
//            {
//                this.glExtensionCompressedTextureS3TC = true;
//            }
...
//                     ((ImmediateRenderObject)object3D).immediateRenderCallback != null)
//            {
//                RemoveInstances(_webglObjectsImmediate, object3D);
//            }
...
//        private readonly Dictionary<int, List<GeometryGroup>> geometryGroups =
//            new Dictionary<int, List<GeometryGroup>>();
...
//        public List<GeometryGroup> MakeGroups(Geometry geometry, bool usesFaceMaterial)
//        {
//            var maxVerticesInGroup = this.extensions.Contains("OES_element_index_uint")
//                ? uint.MaxValue
//                : (uint)short.MaxValue;
...
//                    {
//                        Id = this.geometryGroupCounter++, Faces3 = new List<int>(), MaterialIndex = materialIndex,
//                        Vertices = 0, NumMorphTargets = numMorphTargets, NumMorphNormals = numMorphNormals
//                    };
//                    groups[groupHash] = group;
//                    groupsList.Add(group);
//                }
...
//        /// <param name="geometryGroup"></param>
//        /// <param name="object3D"></param>
//        private void RenderBuffer(Camera camera, IEnumerable<Light> lights, Fog fog, Material material,
//            BaseGeometry geometryGroup, Object3D object3D)
//        {
//            Debug.Assert(null != camera, "");
//            Debug.Assert(null != lights, "");
//            Debug.Assert(null != material, "");
...
//                            "geometryGroup.__webglFaceBuffer has not been created");
//                        GL.BindBuffer(BufferTarget.ElementArrayBuffer, geometryGroup.__webglFaceBuffer);
//                    }

//                    GL.DrawElements(BeginMode.Triangles, geometryGroup.__webglFaceCount, DrawElementsType.UnsignedShort,
//                        0);
...
//        /// <param name="geometry"></param>
//        /// <param name="startIndex"></param>
//        private void SetupVertexAttributes(Material material, WebGlProgram program, BufferGeometry geometry,
//            int startIndex)
//        {
//            var geometryAttributes = geometry.Attributes;
...
//                        GL.BindBuffer(BufferTarget.ArrayBuffer, attributeItem.buffer);
//                        this.EnableAttribute((int)programAttribute);
//                        GL.VertexAttribPointer((int)programAttribute, attributeSize, VertexAttribPointerType.Float,
//                            false, 0, startIndex * attributeSize * sizeof(float));
//                    }
...
//                        GL.BindBuffer(BufferTarget.ArrayBuffer, attributeItem.buffer);
//                        this.EnableAttribute((int)programAttribute);
//                        GL.VertexAttribPointer((int)programAttribute, attributeSize,
//                            VertexAttribPointerType.UnsignedInt, false, 0, startIndex * attributeSize * sizeof(uint));
//                    }
...
//                        this.EnableAttribute((int)programAttribute);
//                        GL.VertexAttribPointer((int)programAttribute, attributeSize,
//                            VertexAttribPointerType.UnsignedShort, false, 0,
//                            startIndex * attributeSize * sizeof(ushort));
//                    }
//                    //else if ( material.defaultAttributeValues ) 
//                    //{
//                    //    if ( material.defaultAttributeValues[ attributeName ].length == 2 )
...
//        /// <param name="geometry"></param>
//        /// <param name="object3D"></param>
//        private void RenderBufferDirect(Camera camera, IEnumerable<Light> lights, Fog fog, Material material,
//            BufferGeometry geometry, Object3D object3D)
//        {
//            if (material.Visible == false)
//            {
//                return;
...
//                                        ((BufferAttribute<ushort>)index).buffer);
//                                if (index is uint[])
//                                    GL.BindBuffer(BufferTarget.ElementArrayBuffer,
//                                        ((BufferAttribute<uint>)index).buffer);
//                                if (index is float[])
//                                    GL.BindBuffer(BufferTarget.ElementArrayBuffer,
//                                        ((BufferAttribute<float>)index).buffer);
//                            }

//                            // render indexed lines

//                            GL.DrawElements(mode, offsets[i].Count, type,
...
//        /// <param name="material"></param>
//        /// <param name="webGlObject"></param>
//        private void RenderImmediateObject(Camera camera, IEnumerable<Light> lights, Fog fog, Material material,
...
//        /// <param name="useBlending"></param>
//        /// <param name="overrideMaterial"></param>
//        private void RenderObjects(IEnumerable<WebGlObject> renderList, Camera camera, IEnumerable<Light> lights,
...
//                    if (useBlending)
//                    {
//                        this.SetBlending(material.Blending, material.BlendEquation, material.BlendSrc,
//                            material.BlendDst);
//                    }
...
//                if (webglObject.buffer is BufferGeometry)
//                {
//                    this.RenderBufferDirect(camera, lights, fog, material, webglObject.buffer as BufferGeometry,
//                        object3D);
//                }
//                else
//                {
...
//        /// <param name="useBlending"></param>
//        /// <param name="overrideMaterial"></param>
//        private void RenderObjectsImmediate(IEnumerable<WebGlObject> renderList, string materialType, Camera camera,
//            IEnumerable<Light> lights, Fog fog, bool useBlending, Material overrideMaterial)
//        {
//            Material material = null;
...
//            return (object3D.Material is MeshFaceMaterial)
//                ? ((MeshFaceMaterial)object3D.Material).Materials[geometryGroup.Id]
//                : object3D.Material;
//        }
...
//            if (textureUnit >= this.MaxTextures)
//            {
//                Trace.TraceWarning("WebGLRenderer: trying to use " + textureUnit +
//                                   " texture units while this GPU supports only " + this.MaxTextures);
//            }
...
//                if (null == material["__webglShader"])
//                {
//                    Trace.TraceError("Shader '{0}' could not be found. Check if it was created in UniformsLib",
//                        shaderId);
//                    return;
//                }
//            }
...
//            var typeArray = (this.glExtensionElementIndexUint && ntris > (ushort.MaxValue / 3))
//                ? typeof(uint)
//                : typeof(ushort);
...
//                catch ( /*OpenTK.exGraphicsException*/ Exception e)
//                {
//                    Trace.TraceError("Setting KVP at location {0}, of type {1}; Message: {2}", location, type,
//                        e.Message);
//                }
//            }
//        }
...
//                    ((null != m.EnvMap) && (m.EnvMap.Mapping is Three.CubeRefractionMapping)) ? 1 : 0);
//            }
...
//        /// <param name="dispose"></param>
//        /// <param name="material"></param>
//        private void SetMeshBuffers(GeometryGroup geometryGroup, Object3D object3D, BufferUsageHint hint, bool dispose,
//            Material material)
//        {
//            if (!geometryGroup.__inittedArrays)
//            {
...
//                GL.BindBuffer(BufferTarget.ArrayBuffer, geometryGroup.__webglVertexBuffer);
//                GL.BufferData(BufferTarget.ArrayBuffer, (IntPtr)(vertexArray.Length * sizeof(float)), vertexArray,
//                    hint);
...
//                {
//                    GL.BindBuffer(BufferTarget.ArrayBuffer, geometryGroup.__webglColorBuffer);
//                    GL.BufferData(BufferTarget.ArrayBuffer, (IntPtr)(colorArray.Length * sizeof(float)), colorArray,
//                        hint);

//                    Debug.WriteLine("BufferData for __webglColorBuffer float[] id {0}",
...
//                GL.BindBuffer(BufferTarget.ArrayBuffer, geometryGroup.__webglNormalBuffer);
//                GL.BufferData(BufferTarget.ArrayBuffer, (IntPtr)(normalArray.Length * sizeof(float)), normalArray,
//                    hint); // * 3 ??????
...
//                {
//                    GL.BindBuffer(BufferTarget.ArrayBuffer, geometryGroup.__webglUVBuffer);
//                    GL.BufferData(BufferTarget.ArrayBuffer, (IntPtr)(uvArray.Length * sizeof(float)), uvArray,
//                        hint); // * 2 ??????
...
//                {
//                    GL.BindBuffer(BufferTarget.ArrayBuffer, geometryGroup.__webglUV2Buffer);
//                    GL.BufferData(BufferTarget.ArrayBuffer, (IntPtr)(uv2Array.Length * sizeof(float)), uv2Array,
//                        hint); // * 3 ??????
...
//                GL.BindBuffer(BufferTarget.ElementArrayBuffer, geometryGroup.__webglFaceBuffer);
//                GL.BufferData(BufferTarget.ElementArrayBuffer, (IntPtr)(faceArray.Length * sizeof(ushort)), faceArray,
//                    hint);

//                Debug.WriteLine("BufferData for __webglFaceBuffer ushort[] id {0}", geometryGroup.__webglFaceBuffer);

//                GL.BindBuffer(BufferTarget.ElementArrayBuffer, geometryGroup.__webglLineBuffer);
//                GL.BufferData(BufferTarget.ElementArrayBuffer, (IntPtr)(lineArray.Length * sizeof(ushort)), lineArray,
//                    hint);
...
//                        (IntPtr)(((float[])customAttribute["array"]).Length * sizeof(float)),
//                        (float[])customAttribute["array"], hint);
...
//                    if (this.gammaInput)
//                    {
//                        this.setColorGamma(dirColors, dirOffset, color,
...
//                        this.setColorGamma(pointColors, pointOffset, color,
...
//            for (var l = dirLength * 3; l < System.Math.Max(dirColors.Count, dirCount * 3); l++) dirColors[l] = 0.0f;
//            for (var l = pointLength * 3; l < System.Math.Max(pointColors.Count, pointCount * 3); l++)
//                pointColors[l] = 0.0f;
//            for (var l = spotLength * 3; l < System.Math.Max(spotColors.Count, spotCount * 3); l++)
//                spotColors[l] = 0.0f;
//            for (var l = hemiLength * 3; l < System.Math.Max(hemiSkyColors.Count, hemiCount * 3); l++)
//                hemiSkyColors[l] = 0.0f;
//            for (var l = hemiLength * 3; l < System.Math.Max(hemiGroundColors.Count, hemiCount * 3); l++)
//                hemiGroundColors[l] = 0.0f;
...
//        /// <param name="object3D"></param>
//        /// <returns></returns>
//        private WebGlProgram SetProgram(Camera camera, IEnumerable<Light> lights, Fog fog, Material material,
//            Object3D object3D)
//        {
//            this._usedTextureUnits = 0;
...
//                    GL.TexImage2D(TextureTarget.Texture2D, 0, glInternalFormat, image.Width, image.Height, 0, glFormat,
//                        glType, data.Scan0);
//                    image.UnlockBits(data);
//                }
//            }
...
//                    else
//                    {
//                        GL.TexImage2D(TextureTarget.Texture2D, level, glInternalFormat, mipmap.Width, mipmap.Height, 0,
...
//                    this.paramThreeToGL(texture.MagFilter));
//                GL.TexParameter(textureTarget, TextureParameterName.TextureMinFilter,
//                    this.paramThreeToGL(texture.MinFilter));
//            }
//            else
//            {
//                GL.TexParameter(textureTarget, TextureParameterName.TextureWrapS, (int)TextureWrapMode.ClampToEdge);
...
//                if (texture.Anisotropy > 1) // || texture.__oldAnisotropy < 0 ) // TODO
//                {
//                    GL.TexParameter(textureTarget,
//                        (TextureParameterName)ExtTextureFilterAnisotropic.TextureMaxAnisotropyExt,
//                        System.Math.Min(texture.Anisotropy, this.MaxAnisotropy));
//                    //             texture.__oldAnisotropy = texture.Anisotropy;// TODO
//                }
//            }
//        }
...
//                        if ((bool)customAttribute["needsUpdate"]
//                            && (!customAttribute.ContainsKey("boundTo") ||
//                                (string)customAttribute["boundTo"] == "vertices"))
//                        {
//                            var cal = ((float[])customAttribute["array"]).Length / (int)customAttribute["size"];
...
//                GL.BindBuffer(BufferTarget.ArrayBuffer, geometry.__webglLineDistanceBuffer);
//                GL.BufferData(BufferTarget.ArrayBuffer, (IntPtr)(lineDistanceArray.Length * sizeof(float)),
//                    lineDistanceArray, hint); // float ??
...
//                    var customAttributesDirty = (material is IAttributes &&
//                                                 (null != ((IAttributes)material).Attributes) &&
//                                                 AreCustomAttributesDirty(material as IAttributes));

//                    if (geometry.VerticesNeedUpdate || geometry.MorphTargetsNeedUpdate || geometry.ElementsNeedUpdate
//                        || geometry.UvsNeedUpdate || geometry.NormalsNeedUpdate || geometry.ColorsNeedUpdate
//                        || customAttributesDirty)
//                    {
//                        this.SetMeshBuffers(geometryGroup, object3D, BufferUsageHint.DynamicDraw, !geometry.Dynamic,
//                            material);
//                    }
//                }
...
//                var customAttributesDirty = (material is IAttributes && (null != ((IAttributes)material).Attributes) &&
//                                             AreCustomAttributesDirty(material as IAttributes));
...
//                if (geometry.VerticesNeedUpdate || geometry.ColorsNeedUpdate || pointCloud.sortParticles ||
//                    customAttributesDirty)
//                {
//                    this.SetParticleBuffers(geometry, BufferUsageHint.DynamicDraw, pointCloud);
//                }
...
//        private int AllocateBones(Object3D object3D)
//        {
//            if (this.supportsBoneTextures &&
//                null != object3D && /*null != object3D.skeleton && object3D.skeleton.useVertexTexture*/ false)
//            {
//                return 1024;
//            }
//            else
...
//                    {
//                        throw new Exception(
//                            $"WebGLRenderer: too many bones - {object3D.Skeleton.Bones.Count}, this GPU supports just {maxBones} (try OpenGL instead of ANGLE)");
//                    }
//                }
