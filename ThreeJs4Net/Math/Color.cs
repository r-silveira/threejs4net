...
namespace ThreeJs4Net.Math
{
    ...
    public struct Color
    {
        ...
        public Color Sub(Color color)
        {
            ...
            this.R = System.Math.Max(0, this.R - color.R);
            this.G = System.Math.Max(0, this.G - color.G);
            this.B = System.Math.Max(0, this.B - color.B);
        ...
        public static Color operator -(Color left, Color right)
        {
            ...
            result.R = System.Math.Max(0, left.R - right.R);
            result.G = System.Math.Max(0, left.G - right.G);
            result.B = System.Math.Max(0, left.B - right.B);
        ...
        public double GetHue()
        {
            ...
            double max = System.Math.Max(rNormalized, System.Math.Max(gNormalized, bNormalized));
            double min = System.Math.Min(rNormalized, System.Math.Min(gNormalized, bNormalized));
