...
namespace ThreeJs4Net.Extras.Core
{
    internal struct Size : IEquatable<Size>
    {
        ...
        //    new Size(unchecked((int)System.Math.Ceiling(value.Width)), unchecked((int)System.Math.Ceiling(value.Height)));
        ...
        //    new Size(unchecked((int)System.Math.Round(value.Width)), unchecked((int)System.Math.Round(value.Height)));
