...
namespace ThreeJs4Net.Geometries.Tests
{
    public class ExtrudeBufferGeometryTests
    {
        ...
        public void ExtrudeBufferGeometryTest4()
        {
            ...
            var geometry = new ShapeBufferGeometry(new List<Shape> {smileyShape});
        ...
        public void ExtrudeBufferGeometryTest3()
        {
            ...
            var options = new Hashtable {{"depth", 1}, {"bevelEnabled", false}};
            var geometry = new ExtrudeBufferGeometry(new List<Shape> { smileyShape}, options);
            var mesh = new Mesh(geometry, new MeshBasicMaterial { Color = Color.ColorName(ColorKeywords.aqua) });
            geometry.RotateX((Mathf.PI / 180) * -90);
        }
        ...
        public void ExtrudeBufferGeometryTest1()
        {
            ...
            var options = new Hashtable {{"depth", 1}, {"bevelEnabled", false}};
            var geometry = new ExtrudeBufferGeometry(new List<Shape> {triangleShape2}, options);
            var mesh = new Mesh(geometry, new MeshBasicMaterial { Color = Color.ColorName(ColorKeywords.aqua) });
            geometry.RotateX((Mathf.PI / 180) * -90);
        }
        ...
        public void ExtrudeBufferGeometryTest2()
        {
            ...
            var options = new Hashtable {{"depth", 1}, {"bevelEnabled", false}};
            var geometry = new ExtrudeBufferGeometry(new List<Shape> {triangleShape}, options);
            geometry.RotateX((Mathf.PI / 180) * -90);
        }
    }
}